...
//        text.setSize(100,30);
        ...
        over.setPreferredSize(new Dimension(150, 50));
    ...
    public void setUpGame(int x,Boolean what){
        ...
        String[] c = {":-D","X","O","-(*.*)-","<>","<(^-^)>","=>",";^P","ABC","123"};//easier version
    ...
    public void winner(){
        ...
        TextField youWin = new TextField("You Win");
        youWin.setFont(new Font("Arial", Font.BOLD, 18)); // Change the font of the text field
        end_screen.add(youWin, BorderLayout.NORTH);
        TextField scoreText = new TextField("Error : " + score);
        scoreText.setFont(new Font("Arial", Font.PLAIN, 18)); // Change the font of the text field
        end_screen.add(scoreText, BorderLayout.SOUTH);
        goBack.setText("Main Menu");
        goBack.setBackground(Color.red);
        goBack.setForeground(Color.white);
        goBack.setPreferredSize(new Dimension(150, 40)); // Increase the size of the button
        goBack.setFont(new Font("Arial", Font.BOLD, 20)); // Change the font of the button
